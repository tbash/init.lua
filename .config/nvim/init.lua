...
-- Enable copy to clipboard equal to yank
...
require('nvim-treesitter.configs').setup {
  ...
  ensure_installed = { 'elixir', 'eex', 'graphql', 'heex', 'html', 'lua', 'javascript', 'vim' },
...
local servers = { 'elixirls', 'elmls', 'graphql', 'html', 'sumneko_lua', 'tailwindcss', 'tsserver' }
